      ...
      <div className="relative min-h-screen flex items-center justify-center px-4">
        <div className="max-w-6xl mx-auto text-center space-y-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">Advanced Git repository security scanner that detects exposed secrets and vulnerabilities before they become threats.</p>
          </div>
